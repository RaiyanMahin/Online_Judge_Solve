...
void baal()
{
    ...
    ll k, n, m; cin >> k >> n >> m; vector < ll > a(k, 0);
    ...
    currently K pepole jei jei city te ache ta shob city theke BFS calaisi
    then countK[i] mane oi city te jawa jabe
    ...
    */
    ...
    /* If countK[i] == k, that means i'th city can be reached by all K people, hence
