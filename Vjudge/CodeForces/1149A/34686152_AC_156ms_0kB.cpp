...
//    ll n; cin >> n; ll op = n * (n - 1), op2 = n * (n - 1);
//    if(n <= 2)
//    {
//        cout << n << endl; return;
//    }
////    if(odd(n))
////    {
////        cout << op * (n - 2 ) << endl; return;
////    }
//    ll tmp = op * (n - 2), tmp2 = op * (n - 3) ; debug(tmp)
//    ll lcm = (n * (n - 2)) / __gcd(n, n - 2) ;
//    ll lcm2 = (n * (n - 1)) / __gcd(n, n - 3) ;
//
//    debug(lcm) debug(lcm2)
//    ll f_ans = lcm * (n - 1); debug(f_ans)
//    ll f_ans2 = lcm2 * (n - 3); debug(f_ans2)
//    cout << max(f_ans, f_ans2) << endl; return;
//
//
