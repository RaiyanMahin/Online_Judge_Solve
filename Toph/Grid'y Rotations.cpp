...
void baal()
{
    ll n, m; cin >> n >> m; ll a[n + 2][m + 2] = {0, 0};
    ...
    while(q--)
    {
        ...
        ll st = a[r][c - 1], op = a[r + 1][c - 1];
         a[r][c - 1] = a[r + 1][c - 1];

        ll stt = a[r - 1][c - 1];  a[r - 1][c - 1] = st;

        ll st2 = a[r - 1][c] ; a[r - 1][c] = stt;

        ll st3 = a[r - 1][c + 1]; a[r - 1][c + 1] = st2;

        ll st4 = a[r][c + 1]; a[r][c + 1] = st3;

        ll st5 = a[r + 1][c + 1]; a[r + 1][c + 1] = st4;

        ll st6 = a[r + 1][c] ; a[r + 1][c] = st5;

        ll st7 = a[r + 1][c - 1]; a[r + 1][c - 1] = st6;
