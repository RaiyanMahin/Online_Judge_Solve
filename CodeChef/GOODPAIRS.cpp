...
void baal()
{
    ...
    for(ll i = 0; i < n; i++)
    {
        pair < ll, ll > op = { b[i], a[i] };
        pair < ll, ll > op1 = { a[i], b[i] };
...
//    for(auto i : mp)
//    {
//        pair < ll, ll > op = {i.F.S, i.F.F};
//        pair < ll, ll > op1 = {i.F.F, i.F.S};
//        debug(i.F.S) debug(i.F.F)
//
//        if(i.F.S != i.F.F)
//        {
//            if(mp.count(op))
