...
//        return 1;
   ...
   ll upper = 0, lower = 0, spe = 0, num = 0;

   for(ll i = 0; i < n; i++)
   {
       if(s[i] >= 97 and s[i] <= 122) lower = 1;

       else if(s[i] >= 65 and s[i] <= 90) upper = 1;

       else if(s[i] >= 48 and s[i] <= 57) num = 1;

       else if(s[i] == '#' or s[i] == '@' or s[i] == '*' or s[i] == '&') spe = 1;

       if(lower and upper and num and spe and (n >= 7))
       {
          // cout << " vitore \n";
           cout << s << nn; return;
