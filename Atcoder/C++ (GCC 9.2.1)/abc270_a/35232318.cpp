...
void BAAL(ll i)
{
        ...
        if(i == 7)
        {
            st.insert(1); st.insert(2); st.insert(4);
        }
    }
...
//        if(i == 3)
//        {
//            mp[i].push_back(1); mp[i].push_back(2);
//
//        }
//        if(i == 4)
//        {
...
//        if(i == 5)
//        {
//            mp[i].push_back(1); mp[i].push_back(4);
//        }
//        if(i == 6)
//        {
//            mp[i].push_back(2); mp[i].push_back(4);
//        }
//        if(i == 7)
//        {
//            mp[i].push_back(1); mp[i].push_back(2); mp[i].push_back(4);
//        }
//    }
//
//    for(auto i : mp[a])
