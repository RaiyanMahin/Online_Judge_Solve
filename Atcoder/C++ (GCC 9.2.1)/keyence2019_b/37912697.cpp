...
void baal()
{
    ...
    string ans = "keyence"; ll m = sz(ans);
 ...
 after s j  kfscience
 after s 0 i + 1 k
 after s j  kofscience
 after s 0 i + 1 k
 after s j  kyofscience
 after s 0 i + 1 k
 after s j  keyofscience
 after s 0 i + 1 ke
 after s j  kee
 after s 0 i + 1 ke
 after s j  kece
 ...
 after s j  kescience
 after s 0 i + 1 ke
 after s j  kefscience
 after s 0 i + 1 ke
 after s j  keofscience
 after s 0 i + 1 ke
 after s j  keyofscience
 after s 0 i + 1 key
 after s j  keye
    ...
    */
    ...
    for(ll i = 0; i < n; i++)
    {
        for(ll j = (n - 1); j > i; j--)
        {
           ...
           // cout << " after s 0 i + 1 " << ss << nn;
            ss += s.substr(j);

           // cout << " after s j  " << ss << nn;
