...
void baal()
{
   ...
   // debug(cur) debug(ans)
    ...
    for(ll i = 0; i < n; i++)
    {
           ...
           // cout << " li ans " << l_ans << " ri ans " << r_ans << " ans = " << ans << nn;
            //cout << ans << ' ';
 
           //cout << " odd i now string " << s << nn;
