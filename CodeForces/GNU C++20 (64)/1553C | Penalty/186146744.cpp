...
ll get_ans1(string s, ll n)
{
    ll od_baki = 0, ev_baki = 0;
 
    ll o_h = 5, e_h = 5;
 
    ll od_jit = 0, ev_jit = 0;
    ...
    for(ll i = 0; i < n; i++)
    {
        ...
        if(even(i))
        {
         ...
         if(( od_jit + o_h < ev_jit ) or ( ev_jit + e_h < od_jit ) )
            {
                ans = i + 1; break;
            }
 
        // ll e_e = ev_jit + e_h, o_o = od_jit + o_h;
...
void baal()
{
    ...
    main idea hoilo 2 ta string generate koraaaa..
   ...
   */
    ...
    */
    ...
    ll op_ans1 = get_ans1(od, 10);
 
    ll op_ans2 = get_ans1(ev, 10);
 
//    cout << " od = " << od << nn;
//
//    cout << " ev = " << ev << nn;
//
//    cout << " ans 1 " << op_ans1 << nn;
//
//    cout << " ans 2 " << op_ans2 << nn;
 
    cout << min(op_ans1, op_ans2) << nn; return;
