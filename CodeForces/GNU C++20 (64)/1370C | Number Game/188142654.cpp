...
{
    /*
    approach hoilo onk observation krsi je 
    n even hoile jdi 
    kono odd divisor thake jeikhane 
    90 / 15  = 6 mane eai even 6 ( 2 theke boro hoilei)
    yes;
    90/ 3 = 30 r choice krbe na but ultimately (2 theke boro hole)
    other option r jnno hobe
    */
    ll chck = 0;
