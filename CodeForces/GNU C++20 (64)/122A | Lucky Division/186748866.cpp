...
//    cout << Ceil(n , a) * Ceil(m , a) ;
    ...
    vector < ll > a;
    a.push_back(4); a.push_back(7);a.push_back(44);a.push_back(77);a.push_back(47);a.push_back(74);
    a.push_back(777); a.push_back(444);
    a.push_back(447); a.push_back(474);
    a.push_back(774); a.push_back(747);
    a.push_back(744); a.push_back(477);
    ll op = 0;
    for(ll i = 0; i < sz(a); i++)
    {
        if(n == a[i] or n % a[i] == 0)
