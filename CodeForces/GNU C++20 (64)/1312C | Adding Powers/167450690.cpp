...
void baal()
{
  ...
  /*
  logic hoilo pow of k,
  1,2,4,8,16... 1 baad e shb pow of k r sum always
  mod zero 0 hbe tc 3 9 dei 59049 chck
  tae array nilm r index value update koira check
  1 any k ^ 0 tae a[i] > 1 er cehe beshi hoile e baad
  */
