...
void baal()
{
    ...
    ll n; cin >> n;  vector < ll > Mx1(n), Mx2(n);
    ...
    {
        ll Mn1 = Mx1[Mx];
        ll Mn2 = *lower_bound(all(MpT), Mx1[Mx]);
        ll op = Mn2 - Mn1;
 
        reverse(Mx2.begin() + op, Mx2.begin() + Mn1 + 1);
...
//    ll a; cin >> a;
//
//     cout << (a * 2) / __gcd(a, 2LL) << nn; return;
//    ll x, s; cin >> x >> s;
//
//
////    sutra hoilo :
////        (a + b) = (a ^ b) + 2 * (a & b);
////        ekhn 2 * (a & b) eta always even hobe
////
////        (a + b) = (a ^ b) + 2 * (a & b);
////
////        even = even + even
