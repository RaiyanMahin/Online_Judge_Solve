...
void baal()
{
   ...
   O.clear(); E.clear();
    ...
    NEW APPROACH
    even 2 tae hoile nijeder moddhe eai pair
 
    else 2 tae odd cz n even
 
    ekhn ekta pair (odd, even) krte parlei kintu hoi jaitese tae oi approach
    */
 
    if(even(ev) and even(od))
    {
        yes; return;
    }
