...
void baal()
{
//    string s; cin >> s; ll n = sz(s); ll k; cin >> k;
//
//    for(ll i = 0; i < (n - k + 1); i++)
//    {
//        string ss = s.substr(i, k);
//        for(ll j = 0; j < sz(ss); j++)
//        {
//
//
//
...
//    if(ss[0] == '0')
//    {
//        for(ll i = 0; i < n - 1; i++) cout << "9";
//
//        cout << nn; return;
//    }

    string ans = ""; ll indx = -1;
   ...
   if(opp - 1 != 0) cout << opp - 1;

   for(ll i = 1; i <= baki; i++) cout << 9;
